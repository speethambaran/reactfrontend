...
function AddSensorType() {
  ...
  const addSensorType = async (e) => {
    e.preventDefault()
    try {
      await axios.post(`${BASE_URL}/device/adddevicefamily`, { subType: sensorType, Type: type, description, deviceFamily: 'Temperature' }).then((response) => {
                    ...
                    <form onSubmit={addSensorType}>
                      <div className="row">
                        ...
                        <div className="col-md-6 mt-2">
                          ...
                          <select className='form-control' onChange={(e) => setSensorParameter(e.target.value)}>
