...
<<<<<<< HEAD:envitusplatformfrontend/src/scenes/livedata/index.jsx
import FloatingActionButtonZoom from "../livedata/LiveScreen"
import EnhancedTable from "../livedata/LivedataTable"
=======
...
>>>>>>> b84647095ebade249a5c578eb671fa49f8902505:envitusplatformfrontend/src/components/LiveData/LiveData.jsx
											...
											<tbody>
												{device &&
													device.map((device, index) => (
														<tr
															onClick={(e) => selectedDevice(device.deviceId)}
														>
